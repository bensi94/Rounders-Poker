...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'username': 'bensi94', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'username': 'bensi94', 'password': 'pw'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentails(self):
        ...
        create_user(username='bensi94', password='testpass')
        payload = {'username': 'bensi94', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_user_authentication_is_required(self):
        """Test that a user can not be retrived from unauthorized"""
